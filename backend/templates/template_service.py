...
class HeliumDefaultAgentTemplateError(Exception):
    pass
...
class TemplateService:
    ...
    async def create_from_agent(
        ...
        if self._is_helium_default_agent(agent):
            raise HeliumDefaultAgentTemplateError("Cannot create template from Helium default agent")
    ...
    async def get_public_templates(
        self,
        is_he2_team: Optional[bool] = None,
        ...
        if is_he2_team is not None:
            query = query.eq('is_he2_team', is_he2_team)
    ...
    def _is_helium_default_agent(self, agent: Dict[str, Any]) -> bool:
        metadata = agent.get('metadata', {})
        return metadata.get('is_helium_default', False)
    ...
    def _map_to_template(self, data: Dict[str, Any]) -> AgentTemplate:
        ...
        return AgentTemplate(
            ...
            is_he2_team=data.get('is_he2_team', False),
