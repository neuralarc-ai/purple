...
2. Build a custom image:
   ...
   docker push neuralarcai/he2:0.1.1
   ```
...
1. Change the `image` parameter in `docker-compose.yml` (that defines the image name `neuralarcai/he2:___`)
...
3. Push the new version: `docker push neuralarcai/he2:0.1.1`
