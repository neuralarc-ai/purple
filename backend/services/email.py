...
class EmailService:
    def __init__(self):
        ...
        self.sender_email = os.getenv('MAILTRAP_SENDER_EMAIL', 'dom@neuralarc.ai')
        self.sender_name = os.getenv('MAILTRAP_SENDER_NAME', 'Helium Team')
    ...
    def send_welcome_email(self, user_email: str, user_name: Optional[str] = None) -> bool:
        ...
        subject = "🎉 Welcome to Neural Arc - Helium — Let's Get Started "
...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
          <title>Welcome to Kortix Helium</title>
  <style>
    body {{
...
<body>
  <div class="container">
    <div class="logo-container">
              <img src="https://i.postimg.cc/WdNtRx5Z/kortix-suna-logo.png" alt="Kortix Helium Logo" class="logo">
    </div>
    <h1>Welcome to Neural Arc - Helium!</h1>

    <p>Hi {user_name},</p>

    <p><em><strong>Welcome to Neural Arc - Helium — we're excited to have you on board!</strong></em></p>
    ...
    <p>Thanks again, and welcome to the Neural Arc - Helium community <span class="emoji">🌞</span></p>

    <p>— The Neural Arc - Helium Team</p>

    <a href="https://he2.ai/" class="button">Go to the platform</a>
  </div>
</body>
</html>"""
...
Welcome to Neural Arc - Helium — we're excited to have you on board!
...
Thanks again, and welcome to the Neural Arc - Helium community 🌞

— The Neural Arc - Helium Team

Go to the platform: https://he2.ai/

---
© 2025 Neural Arc - Helium. All rights reserved.
You received this email because you signed up for a Neural Arc - Helium account."""
