import { Gmail, HubSpot, LinkedIn, Supabase, Twitter, GoogleDrive, GoogleNotion } from '@/components/logos'
                ...
                <div className="mx-auto max-w-5xl px-6">
                    <div className="grid items-center sm:grid-cols-2">
                        <div className="dark:bg-muted/50 relative mx-auto w-fit">
                            <div className="bg-radial to-muted dark:to-black absolute inset-0 z-10 from-transparent to-75%"></div>
