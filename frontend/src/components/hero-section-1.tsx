            ...
            <div className="light">
                ...
                <section className="h-screen">
                    <div className="relative pt-24 md:pt-36">
                        <div className="absolute inset-0 -z-20 h-screen">
                            <Image
                        ...
                        <div className="mx-auto max-w-7xl px-6">
                            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0 text-black">
                                ...
                                <TextEffect
                                    ...
                                    TrueDepth Agents go beyond speed to deliver insights that are richer, smarter, and worth the wait.
                                </TextEffect>
