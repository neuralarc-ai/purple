        ...
        <section className="py-16 md:py-32">
            <div className="mx-auto max-w-5xl space-y-12 px-6">
                <div className="relative z-10 grid items-center justify-center text-center gap-4 md:gap-12">
                    <h2 className="text-4xl xl:text-6xl font-semibold leading-none">Stop switching between AI tools. <br />Start succeeding with one.</h2>
                    <p className="max-w-lg mx-auto">Helium seamlessly integrates with your existing workflows to automate tasks, generate insights, and manage your business operations all from your intelligent digital companion.</p>
                </div>
                ...
                <div className="relative mx-auto grid max-w-4xl divide-x divide-y divide-white/30 border border-white/30 *:p-12 sm:grid-cols-2 lg:grid-cols-3">
                    <div className="space-y-3">
                        <div className="flex items-start gap-2">
                            ...
                            <h3 className="text-sm font-medium">Deeper, reliable intelligence</h3>
                        </div>
                        <p className="text-sm">Advanced AI agents that understand context and deliver accurate insights.</p>
                    </div>
                    <div className="space-y-2">
                        <div className="flex items-start gap-2">
                            <i className="ri-flashlight-line text-base"></i>
                            <h3 className="text-sm font-medium">Automates workflows</h3>
                        </div>
                        <p className="text-sm">Streamline complex processes and accelerate research with intelligent automation.</p>
                    </div>
                    <div className="space-y-2">
                        <div className="flex items-start gap-2">
                            <i className="ri-sparkling-2-line text-base"></i>
                            <h3 className="text-sm font-medium">No-code, simple to use</h3>
                        </div>
                        <p className="text-sm">Build powerful AI workflows without writing code - intuitive interface for everyone.</p>
                    </div>
                </div>
            </div>
        </section>
