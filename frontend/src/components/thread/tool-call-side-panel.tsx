    ...
    <AnimatePresence mode="wait">
      {isOpen && (
        <motion.div
          ...
          className={cn(
            'fixed top-1 bottom-1 md:top-3 right-2 md:bottom-6 shadow-md shadow-foreground/5 dark:shadow-sidebar/50 border rounded-[22px] flex flex-col z-[51] md:z-30 transition-all duration-200 ease-in-out will-change-transform',
            widthClass,
            'bg-background',
