...
const SectionView: React.FC<{ section: Section }> = ({ section }) => {
  return (
    <div>
      ...
      <div className="mx-4 border-b border-zinc-200 dark:border-zinc-800 last:border-b-0">
          ...
          {!isStreaming && hasData && (
            <div className="flex items-center gap-2">
              ...
              {completedTasks === totalTasks && totalTasks > 0 && (
                <Badge
                  variant="outline"
                  className="h-6 py-0.5 bg-green-50 dark:bg-green-900/20 text-green-900 border-green-900/40"
                >
                  <Check className="h-3 w-3" />
                  All complete
                </Badge>
            ...
            {/* <Badge
                ...
                className={
                  isSuccess
                    ...
                    : "bg-gradient-to-b from-rose-200 to-rose-100 text-rose-700 dark:from-emerald-800/50 dark:to-emerald-900/60 dark:text-emerald-300"
                }
              >
                {isSuccess ? (
