                  ...
                  <div className="space-y-3">
                    {files.map((filePath, idx) => {
                      ...
                      return (
                        <div
                          key={idx}
                          className="group relative bg-background border border-zinc-200 dark:border-zinc-800 rounded-xl p-4 hover:border-zinc-300 dark:hover:border-zinc-700 transition-all duration-200 hover:shadow-sm"
                        >
