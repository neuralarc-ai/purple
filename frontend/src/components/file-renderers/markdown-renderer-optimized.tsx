          ...
          components={{
            ...
            table: ({ node, ...props }) => (
              <div className="overflow-x-auto">
                <table className="min-w-full border-collapse border border-muted-foreground/20 my-3 text-sm" {...props} />
              </div>
            ),
            th: ({ node, ...props }) => (
              <th
            ...
            pre: ({ node, ...props }) => <pre className="bg-muted p-2 rounded text-xs font-mono overflow-x-auto mb-2" {...props} />,
          }}
        >
          {processedContent}
        </Response>
