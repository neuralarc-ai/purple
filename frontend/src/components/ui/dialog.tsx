  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      >
        {children}
        {showCloseButton && (
          <DialogPrimitive.Close className="absolute top-2 right-2 h-8 w-8 flex items-center justify-center rounded-full bg-background text-foreground opacity-70 transition-all disabled:pointer-events-none [&_svg]:h-4 [&_svg]:w-4">
            <XIcon />
