...
export async function generateMetadata({ params }): Promise<Metadata> {
  ...
  const fallbackMetaData = {
    title: 'Shared Conversation | Helium AI',
    description: 'Replay this Agent conversation on Helium AI',
    alternates: {
  ...
  try {
    ...
    const title = projectData.name || 'Shared Conversation | Helium AI';
    const description =
      projectData.description ||
      'Replay this Agent conversation on Helium AI';
